...
C PRINT REGISTER NUMBER
      WRITE(DOUT, 1014) DRNUM
C PRINT REGISTER TYPE
      L = IRTYPE + 1
      GOTO (51, 52, 53, 54, 55), L
   51 WRITE(DOUT, 1010) ITEXT
      GOTO 60
   52 WRITE(DOUT, 1011) ITEXT
      GOTO 60
   53 GOTO 60
   54 WRITE(DOUT, 1012) ITEXT
      GOTO 60
   55 WRITE(DOUT, 1013) ITEXT
      GOTO 60
C PRINT REGISTER ADDRESS
   60 WRITE(DOUT, 1015) IRADDR
      GOTO 240
...
C PRINT REGISTER TYPE
  ...
  101 WRITE(DOUT, 1010) ITEXT
      GOTO 110
  102 WRITE(DOUT, 1011) ITEXT
      GOTO 110
  103 GOTO 110
  104 WRITE(DOUT, 1012) ITEXT
      GOTO 110
  105 WRITE(DOUT, 1013) ITEXT
      GOTO 110
C PRINT REGISTER ADDRESS
  110 WRITE(DOUT, 1015) IRADDR
C PRINT REGISTER NUMBER
...
C ** ERROR MESSAGES **
  200 WRITE(DOUT, 1017) DERROR
      GOTO 240
  210 WRITE(DOUT, 1018) DERROR
      GOTO 240
  220 WRITE(DOUT, 1019) DERROR
      GOTO 240
  230 WRITE(DOUT, 1016) DERROR
      GOTO 240
...
C ** FORMAT DECLARATIONS **
 1000 FORMAT(55H MBConv v0.1 * Modbus register number/address converter)
...
C *** CHECK REGISTER TYPE, RESULT: 0..4, 255 ***
      ...
      COMMON/GLBVAR/DOUT, IMITEM(4), IREGTS(10)
      DATA IVALID/255/
      DO 500 I = 0, 4
